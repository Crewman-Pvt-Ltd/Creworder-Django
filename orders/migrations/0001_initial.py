# Generated by Django 4.2.13 on 2024-08-27 06:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orders.order_table')),
                ('order_status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='orders.orderstatus')),
                ('product', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='orders.productmodel')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='order_table',
            name='payment_status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='orders.payment_status'),
        ),
        migrations.AddField(
            model_name='order_table',
            name='payment_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='orders.payment_type'),
        ),
    ]
