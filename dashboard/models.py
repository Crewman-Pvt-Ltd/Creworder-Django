...
class DashboardTiles(models.Model):
    class Meta:
        permissions = (
            ...
            ('can_view_all_dashboard_running_tile', 'Can view all dashboard running tile'),
            ...
            ('can_view_all_dashboard_Pending_tile', 'Can view all dashboard Pending tile'),
            ...
            ('can_view_all_dashboard_repeat_order_tile', 'Can view all dashboard repeat_order tile'),
            ...
            ('can_view_all_dashboard_rejected_tile', 'Can view all dashboard rejected tile'),
            ...
            ('can_view_all_dashboard_in_transit_tile', 'Can view all dashboard in transit tile'),
            ...
            ('can_view_all_dashboard_accepted_tile', 'Can view all dashboard accepted tile'),
            ...
            ('can_view_all_dashboard_no_response_tile', 'Can view all dashboard no response tile'),
            ...
            ('can_view_all_dashboard_total_tile', 'Can view all dashboard total tile'),
            ...
            ('can_view_all_dashboard_future_tile', 'Can view all dashboard future tile'),
            ...
            ('can_view_all_dashboard_delivered_tile', 'Can view all dashboard delivered tile'),
            ...
            ('can_view_all_dashboard_schedule_order_chart', 'Can view all dashboard schedule order chart'),
            ...
            ('can_view_all_dashboard_sales_forecast_chart', 'Can view all dashboard sales forecast chart'),
            ...
            ('can_view_all_dashboard_top_selling_list', 'Can view all dashboard top selling list'),
            ...
            ('can_view_all_dashboard_team_order_list', 'Can view all dashboard team order list'),
            ...
            ('can_view_own_dashboard_in_transit_rto', 'Can view own dashboard in transit rto'),
            ('can_view_all_dashboard_in_transit_rto', 'Can view all dashboard in transit rto'),
            ('can_view_manager_dashboard_in_transit_rto', 'Can view manager dashboard in transit rto'),
            ('can_view_teamlead_dashboard_in_transit_rto', 'Can view team lead dashboard in transit rto'),
            ('can_view_own_dashboard_rto', 'Can view own dashboard rto'),
            ('can_view_all_dashboard_rto', 'Can view all dashboard rto'),
            ('can_view_manager_dashboard_rto', 'Can view manager dashboard rto'),
            ('can_view_teamlead_dashboard_rto', 'Can view team lead dashboard rto'),
            ('can_view_own_dashboard_non_serviceable_tile', 'Can view own dashboard non serviceable tile'),
            ('can_view_all_dashboard_non_serviceable_tile', 'Can view all dashboard non serviceable tile'),
            ('can_view_manager_dashboard_non_serviceable_tile', 'Can view manager dashboard non serviceable tile'),
            ('can_view_teamlead_dashboard_non_serviceable_tile', 'Can view team lead dashboard non serviceable tile'),
            ('can_view_own_dashboard_reattempt_tile', 'Can view own dashboard reattempt tile'),
            ('can_view_all_dashboard_reattempt_tile', 'Can view all dashboard reattempt tile'),
            ('can_view_manager_dashboard_reattempt_tile', 'Can view manager dashboard reattempt tile'),
            ('can_view_teamlead_dashboard_reattempt_tile', 'Can view team lead dashboard reattempt tile'),
            ('can_view_own_dashboard_ofd_tile', 'Can view own dashboard ofd tile'),
            ('can_view_all_dashboard_ofd_tile', 'Can view all dashboard ofd tile'),
            ('can_view_manager_dashboard_ofd_tile', 'Can view manager dashboard ofd tile'),
            ('can_view_teamlead_dashboard_ofd_tile', 'Can view team lead dashboard ofd tile'),
            ('can_view_own_dashboard_lost_tile', 'Can view own dashboard lost tile'),
            ('can_view_all_dashboard_lost_tile', 'Can view all dashboard lost tile'),
            ('can_view_manager_dashboard_lost_tile', 'Can view manager dashboard lost tile'),
            ('can_view_teamlead_dashboard_lost_tile', 'Can view team lead dashboard lost tile'),
            ('can_view_own_dashboard_ndr_tile', 'Can view own dashboard ndr tile'),
            ('can_view_all_dashboard_ndr_tile', 'Can view all dashboard ndr tile'),
            ('can_view_manager_dashboard_ndr_tile', 'Can view manager dashboard ndr tile'),
            ('can_view_teamlead_dashboard_ndr_tile', 'Can view team lead dashboard ndr tile'),
        )
